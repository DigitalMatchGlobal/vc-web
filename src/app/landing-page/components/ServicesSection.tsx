...
const services: Service[] = [
{
  ...
  title: 'Niños 8+',
  targetAge: '8-15 años',
  description: 'Desarrollo motor fundamental y construcción de bases sólidas para el rendimiento futuro',
  benefits: [
  'Desarrollo de habilidades motoras básicas',
  'Prevención de lesiones desde temprana edad',
  'Construcción de disciplina y hábitos saludables',
  'Preparación para deportes competitivos'],

  testimonial: {
    name: 'María González',
    role: 'Madre de Tomás (12 años)',
...
},
{
  id: 'adults',
  title: 'Adultos',
  targetAge: '25-50 años',
  description: 'Optimización de salud y rendimiento físico con enfoque en sostenibilidad y calidad de vida',
  benefits: [
...
},
{
  ...
  targetAge: '16-35 años',
  description: 'Preparación de élite para maximizar rendimiento deportivo y alcanzar objetivos competitivos',
  benefits: [
  'Mejora de velocidad, fuerza y resistencia',
  'Periodización específica por deporte',
  'Preparación mental para competencia',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto">
            Programas diseñados específicamente para cada etapa de desarrollo y objetivo deportivo
          </p>
        </div>
            ...
            index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`
              ...
              <div className={`space-y-6 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                <div className="space-y-2">
                  <div className="font-accent text-sm text-primary uppercase tracking-wide">{service.targetAge}</div>
                  <h3 className="font-headline font-black text-3xl sm:text-4xl text-white">{service.title}</h3>
                  <p className="font-body text-lg text-muted-foreground">{service.description}</p>
                </div>
