    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="col-span-1 space-y-4">
                ...
                <li>
                    <a href="#" className="font-body text-sm text-muted-foreground hover:text-white transition-colors">Privacy Policy</a>
                </li>
                <li>
                    <a href="#" className="font-body text-sm text-muted-foreground hover:text-white transition-colors">Terms of Service</a>
                </li>
                <li>
                    <a href="#" className="font-body text-sm text-muted-foreground hover:text-white transition-colors">Data Deletion</a>
                </li>
                </ul>
            </div>
            </div>
