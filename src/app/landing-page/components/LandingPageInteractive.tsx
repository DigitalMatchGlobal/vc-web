  ...
  // CAMBIO: Se actualiza el orden del array para el sistema de anclas
  const sections = [
    { id: 'inicio', offset: 0 },
    { id: 'sobre-mi', offset: 80 },
    { id: 'servicios', offset: 80 }, // Movido arriba
    { id: 'planes', offset: 80 },    // Movido arriba
    { id: 'equipo', offset: 80 },    // Movido abajo
      ...
      <ConversionTrackingWrapper trackPageView pageTitle="Victor Cuellar">
        <div className="min-h-screen bg-background">
          ...
          <main>
            ...
            {/* ✅ NUEVO ORDEN DE SECCIONES EN EL HTML */}
            <ServicesSection />
            <PlansSection />
            <TeamSection />
